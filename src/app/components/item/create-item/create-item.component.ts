...
export class CreateItemComponent implements OnInit {
	...
	ngOnInit() {
		...
		this.CreateItemForm = new FormGroup ({
			item_name: new FormControl('', [Validators.required, Validators.pattern("^[A-z0-9 ]{2,30}$")]),
			item_price: new FormControl('', [Validators.required, Validators.pattern("^[0-9,.]{4,10}$")]),
